...
export class SidebarComponent implements OnInit {
  ...
  private loadMenuItems(): void {
    this.menuItems = [
      // Admin menu
      { label: 'Panel', icon: 'pi pi-home', route: '/admin/dashboard', roles: ['Admin'] },
  ...
  private filterMenuByRole(): void {
    ...
    this.filteredMenuItems = this.menuItems.filter((item) => item.roles.includes(userRole));
  }
